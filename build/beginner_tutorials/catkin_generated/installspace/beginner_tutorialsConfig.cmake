...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ocs3/hku-atlas/install/${idir}'.  Ask the maintainer 'ocs3 <ocs3@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ocs3/hku-atlas/install/lib;/home/ocs3/hku-atlas/devel/lib;/home/ocs3/HKU-Atlas/devel/lib;/opt/ros/indigo/lib)
