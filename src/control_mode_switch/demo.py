...
class Demo:
    ...
    def __init__(self):
        ...
        self.asic_pub = rospy.Publisher('atlas/atlas_sim_interface_command', AtlasSimInterfaceCommand, queue_size=1)
        self.asis_sub = rospy.Subscriber('atlas/atlas_sim_interface_state', AtlasSimInterfaceState, self.state_cb)
        self.imu_sub = rospy.Subscriber('atlas/imu', Imu, self.imu_cb)
    ...
    def demo(self):
        ...
        # Set k_effort = [255] to indicate that we still want all joints under user control.
        # The stand behavior needs a few iterations before it start outputting force values.
