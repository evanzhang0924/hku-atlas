...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/ocs3/hku-atlas/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/ocs3/hku-atlas/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/ocs3/hku-atlas/install)
...
if(NOT "/home/ocs3/hku-atlas/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/ocs3/hku-atlas/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ocs3 <ocs3@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ocs3/hku-atlas/src/beginner_tutorials/${idir}'.  Ask the maintainer 'ocs3 <ocs3@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ocs3/hku-atlas/devel/lib;/home/ocs3/hku-atlas/devel/lib;/home/ocs3/HKU-Atlas/devel/lib;/opt/ros/indigo/lib)
